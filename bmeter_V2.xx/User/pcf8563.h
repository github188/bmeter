...
extern _PCF8563_Time_Typedef 	 RtcTime;
extern _PCF8563_Date_Typedef   RtcDate;
...
unsigned char PCF8563_GetTime                    (unsigned char PCF_Format, _PCF8563_Time_Typedef* PCF_DataStruct);  //PCF8563读取时间信息

void          PCF8563_SetDate                    (unsigned char PCF_Format,_PCF8563_Date_Typedef* PCF_DataStruct);  //PCF8563写入日期信息
void          PCF8563_GetDate                    (unsigned char PCF_Format,_PCF8563_Date_Typedef* PCF_DataStruct);  //PCF8563读取日期信息
